...
outfilename = "data/datasets/" + "test_data_6_modified_without_radiation.csv"
...
pressure_variables_to_drop = []
surface_variables_to_drop = ['surface_solar_radiation_downwards',
	'forecast_albedo',
	'mean_surface_downward_short_wave_radiation_flux',
	'mean_surface_downward_long_wave_radiation_flux',
	'mean_top_net_short_wave_radiation_flux',
...
data = data.drop(columns = ['starttime', 'endtime', 'Unnamed: 0', 'Unnamed: 0.1', 'pc_increase', 'sd_increase', 'doy', 'time'])
print(data)
